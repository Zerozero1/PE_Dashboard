...
- Inatividade por faixa passou de inscrição para **pessoa (CPF)** (2026-09-23): `dim_medico` ganhou `id_pessoa` (backfill via load_dims); consulta agrupa última emissão por pessoa. Totais: 279.738 pessoas com emissão (Todas) / 68.295 (SP).
